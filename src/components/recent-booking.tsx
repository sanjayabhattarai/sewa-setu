...
export function RecentBooking() {
  ...
  return (
    <div className="w-full bg-blue-50/50 border-b border-blue-100 py-6">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-sm border border-blue-100 p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 w-full">
            ...
            <div>
              <p className="text-xs font-bold text-blue-600 uppercase tracking-wide">Upcoming Appointment</p>
